...
Public Class NParroquia
    Public Function Listar() As DataTable
        Try
            Dim Datos As New DParroquia
    ...
    Public Function Insertar(Obj As EParroquia) As Boolean
        Try
            Dim Datos As New DParroquia
            Datos.Insertar(Obj)
            Return True
    ...
    Public Function Actualizar(Obj As EParroquia) As Boolean
        Try
            Dim Datos As New DParroquia

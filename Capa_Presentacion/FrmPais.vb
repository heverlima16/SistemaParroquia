Public Class FrmPais
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        If Me.ValidateChildren = True And TxtPais.Text <> "" Then
            Dim obj As New Capa_Entidades.EPais
            Dim Negocio As New Capa_Negocio.NPais
            'recibe datos
            obj.Pa_Nombre = TxtPais.Text
    ...
    Private Sub TxtNombre_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles TxtPais.Validating
    ...
    Private Sub DgvListado_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DgvListado.CellDoubleClick
        ...
        TxtPais.Text = DgvListado.SelectedCells.Item(2).Value
    ...
    Private Sub BtnActualizar_Click(sender As Object, e As EventArgs) Handles BtnActualizar.Click
        If Me.ValidateChildren = True And TxtPais.Text <> "" And TxtId.Text <> "" Then
            Dim obj As New Capa_Entidades.EPais
            Dim Negocio As New Capa_Negocio.NPais
            'recibe datos
            obj.IdPais = TxtId.Text
            obj.Pa_Nombre = TxtPais.Text
    ...
    Private Sub BtnEliminar_Click(sender As Object, e As EventArgs) Handles BtnEliminar.Click
        If (MsgBox("Desea eliminar los registros seleccionados?", vbYesNo + vbQuestion, "Eliminar registros") = vbYes) Then
            Try
                Dim Neg As New Capa_Negocio.NPais
